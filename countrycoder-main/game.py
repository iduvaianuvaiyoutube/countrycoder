...
def play_guessing_game():
    ...
    print("\n ⁂ Let's play a guessing game! Think of a country, and I'll try to guess it based on yes/no questions.")
    print("\n ⁂ Answer with 'yes' or 'no'. Type 'exit' to end the game.")
    ...
    while True:
        ...
        if response == 'exit':
            print("\n ⁂ Game ended. I hope you had fun! \n")
            break
        elif response == 'yes':
            print(f"\n ⁂ Hooray! I guessed it. The country is {guess}! \n")
            break
        elif response == 'no':
            print("\n ⁂ Oh, let me try again.")
        else:
            print("\n ⁂ Please answer with 'yes', 'no', or 'exit'.")
