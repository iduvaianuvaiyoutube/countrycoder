...
print(" \n \n") 
print (" Are you want get country's number code you should type country's name \n \n or are you want get country name you should type country code WITHOUT  (+) plus mark.\n\nif are you want exit, type exit. :( \n \nAre you want go to home type 'home'\n\n")

print ("developed by IDUVA 🇱🇰™  \n\n")

print ("If you type the name of the country, put the first letter in captital ≥ For example: Sri Lanka\n \n")
while True:
    ...
    if user_input == 'home':
        file_path = "C:\\Users\\gcc\\Desktop\\countrycoder-main\\home.py"
        try:
    ...
    if user_input in country_codes:  # User entered a country code
        print(f"The country name is {country_codes[user_input]}.")
    else:  # User entered a country name
        ...
        if user_input == 'hi' :
            print ("\n ⁂ hellow there i am country code founder (: \n")

        if user_input == 'Hi' :
            print ("\n ⁂ hellow there i am country code founder (: \n")

        if user_input == 'help' :
            print ("\n ⁂ Hellow I'm here to help you please contact me on whatsapp < type [ contact ] to get my number >  (: \n")
            
        if user_input == 'contact' :
            print ("\n ⁂ contact me on whatsapp - wa.me/94779228250 (: \n\n")

        if user_input == 'type' :
            print ("\n ⁂ I sayed to you type 'contact' ok. ! not type 'type' (: \n\n")   

        if user_input == 'what is your language' :
